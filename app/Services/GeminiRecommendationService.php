...
{
    public function generateRecommendations(array $watchedItems, array $filters = []): array
    {
        $filtersText = empty(array_filter($filters))
            ? "Aucun filtre spécifique demandé."
...
- Si des filtres sont fournis, respecte-les autant que possible.
- Le champ media_type doit être exactement "movie" ou "tv".
- Retourne uniquement du JSON valide.
- Ne mets pas de markdown, pas de ```json, pas de texte avant ou après.
