...
<body>
    <div class="page">
        <header class="header">
            <a href="<?php echo e(url('/')); ?>" class="logo">FILM LIB</a>
            ...
            <nav class="nav">
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-red">Créer un compte</a>
                <?php endif; ?>
            </nav>
        </header>
        ...
        <main>
            <section class="hero">
                <div class="hero-content">
                    ...
                    <div class="actions">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-red">
                                ✦ Accéder à mon espace
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-red">
    ...
    <!-- NOTEZ VOS FILMS -->
    <a href="<?php echo e(route('watched-movies.index')); ?>" class="card">
        <div class="icon">★</div>
    ...
    <!-- IA -->
    <a href="<?php echo e(route('recommendations.index')); ?>" class="card">
        <div class="icon">✦</div>
    ...
    <!-- STREAMING / SEARCH -->
    <a href="<?php echo e(route('search.index')); ?>" class="card">
        <div class="icon">▶</div>
        <h2>Où regarder</h2>
        <p>
...
</html><?php /**PATH C:\laragon\www\filmlib\resources\views/welcome.blade.php ENDPATH**/ ?>