    ...
    <div class="movies-page">
        <div class="movies-container">
            ...
            <div class="page-top">
                ...
                <a href="<?php echo e(route('search.index')); ?>" class="btn-red">
                    ...
                    <?php $__currentLoopData = $movies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="movie-card">
                            ...
                            <div class="movie-content">
                                <span class="badge">
                                    <?php echo e($movie->media_type === 'tv' ? 'Série' : 'Film'); ?>
                                ...
                                <div class="rating-box">
                                    ...
                                    <div class="stars-read">
                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                            <?php echo e($i <= $movie->rating ? '★' : '☆'); ?>

                                        <?php endfor; ?>
                                    </div>

                                    <div class="rating-value">
                                        <?php echo e($movie->rating); ?>/5
                                    </div>
                                </div>

                                <form method="POST" action="<?php echo e(route('watched-movies.update', $movie)); ?>">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="rating-stars">
                                        <?php for($i = 5; $i >= 1; $i--): ?>
                                            <input
                                                type="radio"
                                                id="watched-star-<?php echo e($movie->id); ?>-<?php echo e($i); ?>"
                                                name="rating"
                                                value="<?php echo e($i); ?>"
                                                <?php echo e($movie->rating == $i ? 'checked' : ''); ?>

                                                required
                                            >

                                            <label for="watched-star-<?php echo e($movie->id); ?>-<?php echo e($i); ?>">
                                                ★
                                            </label>
                                        <?php endfor; ?>
                                    </div>
                                ...
                                <form action="<?php echo e(route('watched-movies.destroy', $movie)); ?>" method="POST" class="card-actions">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\filmlib\resources\views/watched-movies/index.blade.php ENDPATH**/ ?>