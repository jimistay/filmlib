            ...
            <div class="flex items-center">
                ...
                <div class="hidden space-x-8 sm:flex sm:ml-10">
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('dashboard') ? 'text-red-600' : 'text-gray-600'); ?>">
                        Espace principal
                    </a>

                    <a href="<?php echo e(route('watched-movies.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('watched-movies.*') ? 'text-red-600' : 'text-gray-600'); ?>">
                        Mes films
                    </a>

                    <a href="<?php echo e(route('recommendations.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('recommendations.*') ? 'text-red-600' : 'text-gray-600'); ?>">
                        Recommandations
                    </a>

                    <a href="<?php echo e(route('search.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('search.*') ? 'text-red-600' : 'text-gray-600'); ?>">
                        Explorer
                    </a>
...
<?php endif; ?>
                        ...
                        <?php if (isset($component)) { $__componentOriginal68cb1971a2b92c9735f83359058f7108 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal68cb1971a2b92c9735f83359058f7108 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('security')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dropdown-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('security'))]); ?>
                            Sécurité
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal68cb1971a2b92c9735f83359058f7108)): ?>
...
</nav><?php /**PATH C:\laragon\www\filmlib\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>